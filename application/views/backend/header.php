<?php 
foreach($silogin as $data_silogin) :
		$nama_user = $data_silogin->nama_user;  
		$foto_user = $data_silogin->foto;
endforeach;
?>  
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<?php echo base_url();?>images/user/<?php echo $foto_user; ?>" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
